...
const CustomerSegmentation = () => {
	return (
		<motion.div
			className='bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6'
			style={{	backgroundColor: "var(--body-color)", borderColor: "var(--shadow-color)", color: "var(--text-color)", }}
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ delay: 0.6 }}
		>
			<h2 className='text-xl font-semibold mb-4' 	style={{color: "var(--text-color)", }}>Customer Segmentation</h2>
