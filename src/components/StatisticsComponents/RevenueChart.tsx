...
const RevenueChart = () => {
	...
	return (
		<motion.div
			className='bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 mb-8'
		...
		>
			<div className='flex justify-between items-center mb-6'>
				<h2 className='text-xl font-semibold' 	style={{color: "var(--text-color)", }}>Revenue vs Target</h2>
				<select
					className='text-white rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500'
					style={{	backgroundColor: "var(--body-color)", borderColor: "var(--shadow-color)", color: "var(--text-color)", }}
